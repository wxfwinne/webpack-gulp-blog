var toT =  require('../js/toTop.js') ;
var startM  = require('../js/domove.js');
require('../css/reset.css');
require('../css/iconfont.css');
require('../css/header_footer.css');
require('../css/index.css');
require('../ico/ico.ico');

//window.xf为设置xf函数为全局函数，不然经过webpack打包后会变成局部函数了
window.xf = function(data) {  //返回的远程文件的数据放在data里面了（要清楚返回的数据是什么格式（可以在浏览器中看），才能对他进行处理和使用）
    ...
    (function () {
        ...
        aSpan[0].onclick = function () {                         //点击左边按钮，图片组向右运动
            ...
            if (onOff) {                                        //初始开关为true 能执行代码
                ...
                startM.startMove(oUl, { "left": 0 }, function () {
        ...
        function run() {                                       //图片组向左运动
            if (onOff) {                                       //初始开关为true 能执行代码
                ...
                startM.startMove(oUl, { "left": -iNow * OneSizeLi }, function () {
